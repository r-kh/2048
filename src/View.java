...
public class View extends JPanel {
    ...
    private com.javarush.task.task35.task3513.Controller controller;

    boolean isGameWon = false;
    boolean isGameLost = false;

    public View(com.javarush.task.task35.task3513.Controller controller) {
        setFocusable(true);
    ...
    private void drawTile(Graphics g2, com.javarush.task.task35.task3513.Tile tile, int x, int y) {
